...
import { View, StyleSheet, Text, Image, Alert, ActivityIndicator, ScrollView, Dimensions} from "react-native";
...
const styles = StyleSheet.create({
    container: {
      ...
      header: {
        height: height * 0.10, // Dynamic height based on screen height
        width: "100%",
