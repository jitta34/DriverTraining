...
const AddCardScreen = () => {
  ...
  const handlePayPress = async () => {
    ...
    setTimeout(async () => {
      ...
      const response = await fetch('http://192.168.154.223:3000/create-payment-intent', {
        method: 'POST',
        headers: {
      ...
      <View style={styles.container}>
        ...
        <CardField
          ...
          onCardChange={(cardDetails) => {
            ...
            setCardDetails(cardDetails); // Add this line
          }}
  ...
  disabled={!cardComplete} // Disable the button if card details are not complete
>
